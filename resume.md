...
- **Location:** Nigeria
- [Portfolio / Personal Website](https://arfs6.github.io) | [Github](https://github.com/arfs6) | [Linkedin](https://www.linkedin.com/in/arfs6)
...
1. B.Sc. Computer Science at [University of Jos](https://unijos.edu.ng) (expected 2027)
    - Current Year: 3rd Year (300 Level).
    - Relevant Coursework: Introduction to Computer Systems, Programming in C++ and Java.
2. Bootcamp Software Engineering at [ALX Africa](https://alxafrica.com) (August 2022 to April 2024)
    - Collaborated with peers on multiple projects (/bin/sh and AirBnB clones).
    - [Certificate](https://arfs6.github.io/assets/images/alx-se-specialization-certificate.png) and [Transcript](https://arfs6.github.io/assets/documents/alx-se-transcript.pdf).
...
1. Open Source Contribution to TWBlue
    ...
    - [Contributed nine (9) merged pull requests](https://github.com/MCV-Software/TWBlue/pulls?q=is%3Apr+author%3AArfs6+).
    - Key contributions:
        - [Automated building and releasing new versions](https://github.com/MCV-Software/TWBlue/pull/567) - Helped restore the release pipeline after 6 months of inactivity, enabling continuous releases for hundreths of users.        - [Created an interface for updating user profile](https://github.com/MCV-Software/TWBlue/pull/547)
...
3. [**Highland FM Roster**](https://github.com/arfs6/highland_fm_roster)
